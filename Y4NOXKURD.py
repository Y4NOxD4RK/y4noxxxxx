...
manglist = requests.get('https://raw.githubusercontent.com/Y4NOxD4RK/y4noxxxxx/main/list.txt')
idd = manglist.text
...
def menu():
    os.system('clear')
    os.system('xdg-open https://t.me/@D4RKHACKER1')
    time.sleep(2)
    print '\x1b[32m.'
    os.system('clear')
    os.system('figlet PY')
    print '\x1b[90;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\x1b[0;1m'
    print 'Chenall telegram: @D4RKHACKER1'
    print '\x1b[90;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\x1b[0;1m'
    print hala
    print '\x1b[90;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\x1b[0;1m'
    action()
